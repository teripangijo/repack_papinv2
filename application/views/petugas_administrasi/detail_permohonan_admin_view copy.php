                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <table class="table table-sm table-borderless table-hover">
                            ...
                            <tr><td>NPWP</td><td>: <?= htmlspecialchars($permohonan_detail['npwp'] ?? ($permohonan_detail['npwp_perusahaan'] ?? '-')); ?></td></tr>
                     ...
                     <div class="row">
                        <div class="col-lg-6 mb-3">
                             <table class="table table-sm table-borderless table-hover">
                                ...
                                <tr><td>Jumlah Diajukan (Permohonan)</td><td>: <?= htmlspecialchars(number_format($lhp_detail['JumlahAju'] ?? ($permohonan_detail['JumlahBarang'] ?? 0) )); ?> Unit</td></tr>
                                ...
                                <tr><td>Jumlah Salah (LHP)</td><td>: <?= htmlspecialchars(number_format($lhp_detail['JumlahSalah'] ?? 0)); ?> Unit</td></tr>
                            </table>
                        </div>
                        <div class="col-lg-6 mb-3">
                             <table class="table table-sm table-borderless table-hover">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-3"> <?php // Ubah menjadi col-lg-12 agar lebih rapi jika hanya ini ?>
                            ...
                            <table class="table table-sm table-borderless table-hover">
                                ...
                                <?php elseif($permohonan_detail['status'] == '3'): ?>
                                     <tr><td>File Surat Persetujuan</td><td>: <span class="text-muted"><em>Tidak ada file diupload</em></span></td></tr>
                                <?php endif; ?>
                        ...
                        <div class="col-lg-12 mb-3">
                            ...
                            <div class="p-2 border bg-light rounded">
                                <?= nl2br(htmlspecialchars($permohonan_detail['catatan_penolakan'])); ?>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
