                ...
                <form action="<?= base_url() ?>petugas_administrasi/editLHP/<?= $permohonan['id']; ?>" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input id="TglPeriksa" name="TglPeriksa" value="<?= $lhp['TglPeriksa']; ?>" placeholder="Tanggal Pemeriksaan">
                        </div>
                        <div class="col">
                            <label>Waktu Mulai</label>
                            <input id="wkmulai" name="wkmulai" value="<?= $lhp['wkmulai']; ?>" placeholder="Tanggal Pemeriksaan">
                        </div>
                        <div class="col">
                            <label>Waktu Selesai</label>
                            <input id="wkselesai" name="wkselesai" value="<?= $lhp['wkselesai']; ?>" placeholder="Tanggal Pemeriksaan">
                        </div>
                        <div class="col">
                            <label>Lokasi</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="nomorST" name="nomorST" value="<?= $lhp['nomorST']; ?>" placeholder="Nomor Surat Tugas">
                        </div>
                        <div class="col">
                            <label>Tanggal ST</label>
                            <input id="tgl_st" name="tgl_st" value="<?= $lhp['tgl_st']; ?>" placeholder="Tanggal Surat Tugas">
                        </div>
                    </div>
                    </br>
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="JumlahBenar" name="JumlahBenar" value="<?= $lhp['JumlahBenar']; ?>" placeholder="Jumlah Sebenarnya">
                        </div>
                        <div class="col">
                            <label>Kondisi</label>
                            <input type="text" class="form-control" id="Kondisi" name="Kondisi" value="<?= $lhp['Kondisi']; ?>" placeholder="Kondisi">
                        </div>
                        <div class="col">
                            <label>Pemilik Barang</label>
                            <input type="text" class="form-control" id="pemilik" name="pemilik" value="<?= $lhp['pemilik']; ?>" placeholder="Pemilik Barang">
                        </div>
                    </div>
                    </br>
                    <div class="row">
                        <div class="col">
                            ...
                            <textarea rows="3" type="text" class="form-control" id="Kesimpulan" name="Kesimpulan" value="<?= $lhp['Kesimpulan']; ?>"><?php echo $lhp['Kesimpulan']; ?> </textarea>
                        </div>
                    </div>
                    <div class="row">
