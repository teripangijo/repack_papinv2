        ...
        <div class="card-body">
            ...
            <form action="<?= site_url('admin/edit_user/' . $target_user_data['id']); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="<?= $login_identifier_type; ?>" class="form-control" id="login_identifier" name="login_identifier" value="<?= set_value('login_identifier', $target_user_data['email']); ?>" required>
                ...
                <?php
                    $is_target_petugas = ($target_user_data['role_id'] == 3); 
